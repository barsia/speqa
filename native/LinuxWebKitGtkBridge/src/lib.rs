...
#[no_mangle]
pub extern "system" fn Java_io_github_barsia_speqa_webview_internal_linux_LinuxWebKitGtkBridge_createNative(
    mut env: JNIEnv<'_>,
    _class: JClass<'_>,
    parent_xid: jlong,
    backend: jint,
...
#[no_mangle]
pub extern "system" fn Java_io_github_barsia_speqa_webview_internal_linux_LinuxWebKitGtkBridge_destroyNative(
    mut env: JNIEnv<'_>,
    _class: JClass<'_>,
    handle: jlong,
) {
...
#[no_mangle]
pub extern "system" fn Java_io_github_barsia_speqa_webview_internal_linux_LinuxWebKitGtkBridge_attachToParentNative(
    mut env: JNIEnv<'_>,
    _class: JClass<'_>,
    handle: jlong,
    parent_xid: jlong,
...
#[no_mangle]
pub extern "system" fn Java_io_github_barsia_speqa_webview_internal_linux_LinuxWebKitGtkBridge_detachNative(
    mut env: JNIEnv<'_>,
    _class: JClass<'_>,
    handle: jlong,
) {
...
#[no_mangle]
pub extern "system" fn Java_io_github_barsia_speqa_webview_internal_linux_LinuxWebKitGtkBridge_setBoundsNative(
    mut env: JNIEnv<'_>,
    _class: JClass<'_>,
    handle: jlong,
    x: jint,
...
#[no_mangle]
pub extern "system" fn Java_io_github_barsia_speqa_webview_internal_linux_LinuxWebKitGtkBridge_setVisibleNative(
    mut env: JNIEnv<'_>,
    _class: JClass<'_>,
    handle: jlong,
    visible: jboolean,
...
#[no_mangle]
pub extern "system" fn Java_io_github_barsia_speqa_webview_internal_linux_LinuxWebKitGtkBridge_focusNative(
    mut env: JNIEnv<'_>,
    _class: JClass<'_>,
    handle: jlong,
) {
...
#[no_mangle]
pub extern "system" fn Java_io_github_barsia_speqa_webview_internal_linux_LinuxWebKitGtkBridge_clearFocusNative(
    mut env: JNIEnv<'_>,
    _class: JClass<'_>,
    handle: jlong,
) {
...
#[no_mangle]
pub extern "system" fn Java_io_github_barsia_speqa_webview_internal_linux_LinuxWebKitGtkBridge_loadHtmlNative(
    mut env: JNIEnv<'_>,
    _class: JClass<'_>,
    handle: jlong,
    html: JString<'_>,
...
#[no_mangle]
pub extern "system" fn Java_io_github_barsia_speqa_webview_internal_linux_LinuxWebKitGtkBridge_evaluateJavaScriptNative(
    mut env: JNIEnv<'_>,
    _class: JClass<'_>,
    handle: jlong,
    eval_id: jlong,
...
#[no_mangle]
pub extern "system" fn Java_io_github_barsia_speqa_webview_internal_linux_LinuxWebKitGtkBridge_deliverJsonToJavaScriptNative(
    mut env: JNIEnv<'_>,
    _class: JClass<'_>,
    handle: jlong,
    raw_json: JString<'_>,
...
#[no_mangle]
pub extern "system" fn Java_io_github_barsia_speqa_webview_internal_linux_LinuxWebKitGtkBridge_shutdownRuntimeNative(
    _env: JNIEnv<'_>,
    _class: JClass<'_>,
) {
