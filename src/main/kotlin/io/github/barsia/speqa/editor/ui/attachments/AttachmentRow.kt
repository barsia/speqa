...
internal class AttachmentRow(
    ...
    init {
        ...
        val nameLabel = JBLabel(displayName)
        if (isMissing) {
            ...
            nameLabel.toolTipText = SpeqaBundle.message("tooltip.attachmentMissing", fileName)
        } else {
            // No tooltip for present files — the preview popover already shows the file.
        }
        add(nameLabel)
